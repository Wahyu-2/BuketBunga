...
<head>
  ...
  <!-- Langkah 5: Tambahkan link rel ke file CSS -->
  <link rel="stylesheet" href="{{ asset('/styles026/styles026.css') }}">
...
<header class="antialiased">
  <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex flex-wrap justify-between items-center">
          <div class="flex justify-start items-center">
              ...
              <a href= http://127.0.0.1:8000/# class="flex mr-4 pr-3">
                <img src="https://flowbite.s3.amazonaws.com/logo.svg" class="mr-3 h-8" alt="FlowBite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
              </a>
              <form action="#" method="GET" class="hidden lg:block lg:pl-2 ml-3">
        ...
        <input type="text" name="email" id="topbar-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search">
          ...
          <div class="flex items-center lg:order-2">
              ...
              <!<button id="toggleSidebarMobileSearch" type="button" class="p-6 text-gray-500 rounded-lg lg:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
  ...
  <!-- Langkah 4: Tambahkan tag <h1> -->
  <h1>Halo Dunia!</h1>

  <!-- Langkah 3: Tambahkan 2 gambar -->
  <div class="flex justify-center space-x-6">
  <img src="{{ asset('image_026/flower1.jpg') }}" alt="Gambar 1" width="500px">
  <img src="{{ asset('image_026/flower2.jpg') }}" alt="Gambar 2" width="500px">
  <img src="{{ asset('image_026/flower3.jpg') }}" alt="Gambar 3" width="500px">
  </div>
